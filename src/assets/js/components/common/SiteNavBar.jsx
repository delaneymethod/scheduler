				...
				<nav className="row no-gutters p-0 m-0 navbar navbar-expand-lg navbar-dark bg-dark">
					<div className="navbar-collapse collapse w-100 p-0 m-0 order-2 order-sm-2 order-md-1 order-lg-2 order-xl-2" id="navbar">
						<ul className="p-0 m-0 nav navbar-nav ml-auto w-100 justify-content-end">
							...
							<li className="nav-item p-0 m-0 pl-1 pr-1"><a href="#about" title="About" className="nav-link">About</a></li>
							<li className="nav-item p-0 m-0 pl-1 pr-1"><a href="#beta" title="Beta" className="nav-link">Beta</a></li>
							<li className="nav-item p-0 m-0 pl-1 pr-1"><a href="#pricing" title="Pricing" className="nav-link">Pricing</a></li>
							<li className="nav-item p-0 m-0 pl-1 pr-1"><a href={routes.LOGIN.URI} title={routes.LOGIN.TITLE} className="nav-link">{routes.LOGIN.TITLE}</a></li>
							<li className="nav-item p-0 m-0 pl-1 pr-1"><a href={routes.REGISTER.URI} title={routes.REGISTER.TITLE} className="nav-link">{routes.REGISTER.TITLE}</a></li>
						</ul>
					</div>
