	...
	render = () => (
		<Fragment>
			...
			<FormWithConstraints ref={(el) => { this.form = el; }} onSubmit={this.handleSubmit} noValidate>
				...
				<Button type="submit" color="primary" className="mt-4" id="submitUpdateYourPassword" title={routes.UPDATE_YOUR_PASSWORD.TITLE} tabIndex="3" block>{routes.UPDATE_YOUR_PASSWORD.TITLE}</Button>
			</FormWithConstraints>
		</Fragment>
	);
}
