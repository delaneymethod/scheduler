			...
			HOME: {
				...
				CONTENT: {
					INTRODUCTION: {
						...
						OVERVIEW: '<p>Our <strong>Online Rota Software</strong> lets you quickly create <strong>budgeted schedules</strong> to meet changing demand and <strong>employee availability</strong>.</p><p>Why not dive on in and create your <strong>first&nbsp;Rota</strong>.</p>',
						CALL_TO_ACTION: {
							TITLE: 'Get Started',
							URI: '/register',
						},
					...
					BETA: {
						LEAD: 'Beta Release',
						OVERVIEW: '<p class="question"><strong>Why is Scheduler available as a Beta&nbsp;release?</strong></p><p>Our Online Rota Software is a new product with all the features essential to quickly create, publish and communicate flexible and adaptable schedules for your&nbsp;employees.</p><p>The product, however, is still in development and over the coming months we will be regularly adding new&nbsp;features.</p><p class="question"><strong>As a business user can I influence which features and functionality are&nbsp;prioritised?</strong></p><p>The purpose for releasing our online rota software as a Beta release is to give new and existing customers an opportunity to road test our software and to provide us with essential feedback on how it can be developed and&nbsp;improved.</p><p>We will be encouraging users to give us honest and critical feedback and advice on each feature and recommend new features that would ensure the software meets their&nbsp;needs.</p><p class="question"><strong>How much will I have to pay to use the Online Rota Software – Beta Release?</strong></p><p>The Beta release is available to use <strong>free&nbsp;of&nbsp;charge</strong>.</p><p class="question"><strong>Will I have to pay for the Online Rota Software when the Beta period has&nbsp;ended?</strong></p><p>Users who sign up to use the service whilst it is in Beta will be able to transfer from Beta to the commercial version when released and will be given a six month subscription to the commercial version free&nbsp;of&nbsp;charge.</p><p class="question"><strong>How much will the full version of the Online Rota Service cost?</strong></p><p>We have not yet finalised pricing for the commercial version of the application however we are committed to ensuring a scalable pricing model that is affordable for all types and sizes of business and reflects the value different customers are able to gain from the&nbsp;service.</p><p>Submit your email address here for notifications on service updates and early bird pricing information.</p>',
					},
					PRICING: {
						LEAD: 'Pricing',
						OVERVIEW: '',
					...
					SERVICE_UPDATES: {
						LEAD: '',
						OVERVIEW: '<p>Submit your email address here for notifications on service updates and early bird pricing&nbsp;information.</p>',
						CALL_TO_ACTION: {
